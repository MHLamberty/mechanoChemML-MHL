...
if __name__ == "__main__":
    ...
    cases = [
        # 1) Unconfined compression: measure RF2 on YMAX
        {
            ...
            "inp_path": "Strain_0p3" / "HE_Unconfined_0p3.inp",
            "u_csv": "Strain_0p3" / "cube_U_HE_Unconfined_0p3.csv",
            "rf_meas": read_rf_component("Strain_0p3" / "cube_RF2_HE_Unconfined_0p3.txt", "RF2_top"),
            "meas_face": "YMAX",
        ...
        # 2) Confined compression: measure RF2 on YMAX
        {
            "name": "HE_Confined",
            "bc_mode": "HE_Confined",
            "inp_path": "Strain_0p3" / "HE_Confined_0p3.inp",
            "u_csv": "Strain_0p3" / "cube_U_HE_Confined_0p3.csv",
            "rf_meas": read_rf_component("Strain_0p3" / "cube_RF2_HE_Confined_0p3.txt", "RF2_top"),
            "meas_face": "YMAX",
            "load_dir": (0.0, 1.0, 0.0),
        },
        ...
        # 3) Plane strain (still loaded in Y): measure RF2 on YMAX
        {
            ...
            "inp_path": "Strain_0p3" / "HE_PlaneStrain_0p3.inp",
            "u_csv": "Strain_0p3" / "cube_U_HE_PlaneStrain_0p3.csv",
            "rf_meas": read_rf_component("Strain_0p3" / "cube_RF2_HE_PlaneStrain_0p3.txt", "RF2_top"),
            "meas_face": "YMAX",
            "load_dir": (0.0, 1.0, 0.0),
        },
        ...
        # 4) Simple shear in X: measure RF1 on YMAX
        {
            ...
            "inp_path": "Strain_0p3" / "HE_SimpleShear_0p3.inp",
            "u_csv": "Strain_0p3" / "cube_U_HE_SimpleShear_0p3.csv",
            "rf_meas": read_rf_component("Strain_0p3" / "cube_RF1_HE_SimpleShear_0p3.txt", "RF1_top"),
            "meas_face": "YMAX",
        ...
        # If you're only fitting using RF2 on YMAX, do this:
        {
            ...
            "inp_path": "Strain_0p3" / "HE_BiaxialStretch_0p3.inp",
            "u_csv": "Strain_0p3" / "cube_U_HE_BiaxialStretch_0p3.csv",
            "rf_meas": read_rf_component("Strain_0p3" / "cube_RF2_HE_BiaxialStretch_0p3.txt", "RF2_top"),
            "meas_face": "YMAX",
            "load_dir": (0.0, 1.0, 0.0),
        },
        # 5B) Biaxial stretch:
        # If you're only fitting using RF2 on YMAX, do this:
        {
            ...
            "inp_path": "Strain_0p3" / "HE_BiaxialStretch_0p3.inp",
            "u_csv": "Strain_0p3" / "cube_U_HE_BiaxialStretch_0p3.csv",
            "rf_meas": read_rf_component("Strain_0p3" / "cube_RF1_HE_BiaxialStretch_0p3.txt", "RF1_top"),
            "meas_face": "XMAX",
            "load_dir": (1.0, 0.0, 0.0),
        },
    ]
